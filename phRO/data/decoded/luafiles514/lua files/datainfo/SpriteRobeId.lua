...
SPRITE_ROBE_IDs =
{
	...
	ROBE_KIRIN_WING	= 6,
	ROBE_Ribbon_Piamat	= 7,    -- 사용하지 않음. 사용할 계획 없음.
	ROBE_RUDRA_WING	= 8,
	...
	ROBE_C_2018_RTC_Cape_TW = 28,   -- 대만요청으로 만들어졌으나, 이미지가 제작되지 않음.
	...
	ROBE_Violet_Halo = 39,
	ROBE_CherryFesRibbon = 40,    -- 대만요청으로 만들어졌으나, 이미지가 제작되지 않음.
	ROBE_SnackParty = 41,         -- 대만요청으로 만들어졌으나, 투구로 대체되면서 사용되지 않음.
	ROBE_AngelRibbonWing = 42,    -- 대만요청으로 만들어졌으나, 이미지가 제작되지 않음.
	ROBE_BlackBearBackpack = 43,  -- 대만요청으로 만들어졌으나, 이미지가 제작되지 않음.
	...
	ROBE_Archangel_Wing = 49,     -- 대만요청으로 만들어졌으나, 이미지가 제작되지 않음.
	ROBE_WingOfHeart = 50,
  ...
  ROBE_C_Cat_Fork	= 53,
	...
	ROBE_Wing_Of_Angel_Move = 61, -- 움직이는 걸칠것 테스트용 의상. 이미지 있으나 사용되지 않음.
