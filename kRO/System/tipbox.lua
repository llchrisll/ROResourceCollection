...
, 
[6007] = {Title = "Q 이계와 이종족에 관한 보고서 (95)#애쉬#바쿰#13.1#", Search = 1, Image = "유저인터페이스\\tipbox\\tip06007", 
Imgcoord = {Position = 5, Size = 100}
, 
...
, 
[10157] = {Title = "큐펫 스톤 슈터#식물 영양제#기름야자 열매", Search = 1, Image = "유저인터페이스\\tipbox\\tip10090", 
Imgcoord = {Position = 5, Size = 100}
, 
