...
, 
["1@exsr.rsw"] = {displayName = "내면의 세계", notifyEnter = true, 
signName = {mainTitle = "내면의 세계"}
, backgroundBmp = "field2_s2"}
, 
["1@exds.rsw"] = {displayName = "무명산 산자락", notifyEnter = true, 
signName = {mainTitle = "무명산 산자락"}
, backgroundBmp = "field2_s2"}
, 
["2@exds.rsw"] = {displayName = "무명산 산자락", notifyEnter = true, 
signName = {mainTitle = "무명산 산자락"}
, backgroundBmp = "field2_s2"}
, 
["1@exse.rsw"] = {displayName = "은하 천계 분소", notifyEnter = true, 
signName = {mainTitle = "은하 천계 분소"}
, backgroundBmp = "field2_s2"}
, 
["1@exhn.rsw"] = {displayName = "노비스의 기억", notifyEnter = true, 
signName = {mainTitle = "노비스의 기억"}
, backgroundBmp = "field2_s2"}
, 
["1@exsh.rsw"] = {displayName = "깊은 숲", notifyEnter = true, 
signName = {mainTitle = "깊은 숲"}
, backgroundBmp = "field2_s2"}
, 
["bl_grass.rsw"] = {displayName = "바이오스피어 표본 환경-초원", notifyEnter = true, 
signName = {subTitle = "바르문트의 바이오스피어", mainTitle = "표본 환경 - 초원"}
, backgroundBmp = "dungeon"}
, 
["bl_lava.rsw"] = {displayName = "바이오스피어 표본 환경-화염", notifyEnter = true, 
signName = {subTitle = "바르문트의 바이오스피어", mainTitle = "표본 환경 - 화염"}
, backgroundBmp = "dungeon"}
, 
["bl_ice.rsw"] = {displayName = "바이오스피어 표본 환경-혹한", notifyEnter = true, 
signName = {subTitle = "바르문트의 바이오스피어", mainTitle = "표본 환경 - 혹한"}
, backgroundBmp = "dungeon"}
, 
["bl_death.rsw"] = {displayName = "바이오스피어 표본 환경-죽음", notifyEnter = true, 
signName = {subTitle = "바르문트의 바이오스피어", mainTitle = "표본 환경 -  죽음"}
, backgroundBmp = "dungeon"}
, 
...
signName = {subTitle = "글로리아", mainTitle = "하이네"}
, backgroundBmp = "siege"}
, 
