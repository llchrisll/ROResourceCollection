...
, 
{name = "Blacksmith", X = 178, Y = 186, TYPE = 3}
, 
...
, 
prt_monk = {
{name = "Weapons", X = 135, Y = 263, TYPE = 1}
}
, 
izlude = {
...
, 
{name = "Miscellaneous", X = 151, Y = 241, TYPE = 0}
, 
{name = "Miscellaneous", X = 146, Y = 103, TYPE = 0}
}
, 
moc_ruins = {
...
, 
{name = "Miscellaneous", X = 87, Y = 65, TYPE = 0}
}
, 
mjolnir_02 = {
...
, 
{name = "Blacksmith", X = 224, Y = 172, TYPE = 3}
}
, 
xmas = {
{name = "Convenience", X = 148, Y = 134, TYPE = 6}
, 
...
{name = "Guide", X = 167, Y = 76, TYPE = 4}
, 
{name = "Miscellaneous", X = 100, Y = 118, TYPE = 0}
, 
...
, 
{name = "Styling Shop", X = 134, Y = 113, TYPE = 7}
}
, 
cmd_fild07 = {
{name = "Merchant", X = 257, Y = 126, TYPE = 0}
, 
{name = "Armors", X = 277, Y = 85, TYPE = 2}
}
, 
harboro1 = {
{name = "Convenience Service", X = 291, Y = 207, TYPE = 6}
, 
{name = "Hotel", X = 156, Y = 215, TYPE = 5}
, 
{name = "Guide", X = 356, Y = 211, TYPE = 4}
, 
{name = "Guide", X = 80, Y = 211, TYPE = 4}
, 
{name = "Shop", X = 312, Y = 193, TYPE = 0}
}
, 
prt_mk = {
{name = "Convenience", X = 162, Y = 153, TYPE = 6}
, 
{name = "Convenience", X = 172, Y = 24, TYPE = 6}
, 
{name = "Convenience", X = 295, Y = 171, TYPE = 6}
, 
{name = "Convenience", X = 28, Y = 154, TYPE = 6}
, 
{name = "Convenience", X = 152, Y = 299, TYPE = 6}
, 
{name = "Guide", X = 252, Y = 300, TYPE = 4}
, 
{name = "Guide", X = 299, Y = 67, TYPE = 4}
, 
{name = "Guide", X = 71, Y = 20, TYPE = 4}
, 
{name = "Guide", X = 24, Y = 256, TYPE = 4}
, 
{name = "Guide", X = 161, Y = 171, TYPE = 4}
, 
{name = "Store", X = 297, Y = 47, TYPE = 0}
, 
{name = "Store", X = 53, Y = 23, TYPE = 0}
, 
{name = "Store", X = 27, Y = 275, TYPE = 0}
, 
{name = "Store", X = 272, Y = 299, TYPE = 0}
}
}
main = function()
  -- function num : 0_0
